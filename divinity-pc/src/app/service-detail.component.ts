      ...
      <div class="pt-24 pb-12 px-4 max-w-5xl mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          @for (card of service()!.cards; track card.title) {
            <div class="bg-brand-card border border-brand-border rounded-2xl p-8 hover:border-brand-blue/30 transition-colors">
              <div class="w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center mb-6">
